var SysAppWizard={
	...
	showDlgWizard:function(conf){
		...
		this.a.div.innerHTML='<iframe id="'+id+'" style="width:850px;height:550px;borderby:none;background:white" src="site/0/0/step1.html"></iframe></br><button id="butBack" class="w2ui-btn" onclick="SysAppWizard.go(-1)">Close</button> <button id="butNext" class="w2ui-btn" onclick="SysAppWizard.go(1)">Next</button>';
	},
	go:function(index){
		var id="div_SysAppWizard";
