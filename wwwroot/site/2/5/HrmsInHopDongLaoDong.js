				...
				NUT.ds.select({ url: InHopDongLaoDong.url +"data/nhansu",where:["manhanvien","=",hd.manhanvien]},function(res){
					if(res.success && res.result.length){
						...
						win_hd.onload=function(){
							...
							this.hd_quoctich.innerHTML=NUT.domain[22].lookup[nv.quoctich]||"";
							this.hd_ngaysinh.innerHTML=NUT.dmy(nv.ngaysinh)||"";
							this.hd_gioitinh.innerHTML=NUT.domain[20].lookup[nv.gioitinh]||"";
							...
							this.hd_loaihopdong.innerHTML=NUT.domain[37].lookup[hd.loaihopdong]||"";
							...
							this.hd_diadiemlv.innerHTML = (nv.diadiemlv || "") + " - " + (NUT.domain[9].lookup[nv.makhuvuc]||"");
							this.hd_vitrilv.innerHTML = NUT.domain[14].lookup[hd.vitrilamviec]||"";
							...
							if(full){
								...
								this.ck_vitrilv.innerHTML = NUT.domain[14].lookup[nv.vitrilv]||"";
								this.ck_vitrilv2.innerHTML = NUT.domain[14].lookup[nv.vitrilv]||"";
