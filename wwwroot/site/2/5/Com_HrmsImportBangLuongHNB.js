var Com_HrmsImportBangLuongHNB={
	run:function(p){
		this.conf=p.config;
		var id="divCom_HrmsImportBangLuongHNB";
		...
		w2popup.open({
			...
			buttons: '<button class="w2ui-btn" onclick="w2popup.close()">⛌ Close</button><button class="w2ui-btn" onclick="Com_HrmsImportBangLuongHNB.insert('+id+'.value)">✔️ Import</button>'
		});
	},
	insert:function(csv){
