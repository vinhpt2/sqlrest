var Com_HrmsCheckInOut={
					...
					if(res.length){
						for(var i=0;i<res.length;i++){
							...
							if(data.thoigianden){
								...
								html+='<td><div id="divInOut_IN'+lan+'" class="nut-tile" style="background:green" onclick="Com_HrmsCheckInOut.divInOut_InfoIn(this,'+id+')"><img src="client/2/img/in.ico"><br/><b>'+data.madiemban+'<br/>'+data.thoigianden+'</b></div></td>';
								if(data.thoigianve){
									data.thoigianve=new Date(data.thoigianve).toLocaleTimeString();
									html+='<td><div id="divInOut_OUT'+lan+'" class="nut-tile" style="background:orange" onclick="Com_HrmsCheckInOut.divInOut_InfoOut(this,'+id+')"><img src="client/2/img/out.ico"><br/><b>OUT<br/>'+data.thoigianve+'</b></div></td>';
	...
	divInOut_InfoIn:function(elm,id){
		...
		w2alert("<table style='width:500px'><caption style='color:green'><b>Check IN <i>#"+data.nam+"-"+data.thang+"-"+data.ngay+"</i></b></caption><tr><td><b><i>Thời gian đến:</i></b></td><td>"+data.thoigianden+"</td></tr><tr><td><b><i>Khu vực:</i></b></td><td>"+data.makhuvuc+"</td></tr><tr><td><b><i>Điểm bán:</i></b></td><td>"+data.madiemban+"</td></tr></table>");
	},
	divInOut_InfoOut:function(elm,id){
		var data=Com_HrmsCheckInOut.lookupData[id];
		w2alert("<table style='width:500px'><caption style='color:orange'><b>Check OUT <i>#"+data.nam+"-"+data.thang+"-"+data.ngay+"</i></b></caption><tr><td><b><i>Thời gian về:</i></b></td><td>"+data.thoigianve+"</td></tr><tr><td><b><i>Khu vực:</i></b></td><td>"+data.makhuvuc+"</td></tr><tr><td><b><i>Điểm bán:</i></b></td><td>"+data.madiemban+"</td></tr></table>");
